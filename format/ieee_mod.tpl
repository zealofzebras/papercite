...
Purpose:
       We do not have MASTERSTHESIS, but we have Diploma @_@and@;_@ Bachelor Theses, these will be stored as MASTERSTHESIS

Changes:
       -MASTERTHESIS @_@and@;_@ PHDTHESIS are separated
...
<format types="book">
@?author@@author@, @;@@?title@&lt;span style=&quot;font-style: italic&quot;&gt;@title@&lt;/span&gt;@;@@?edition@, @edition@ @_@ed.@;_@@;@@?editor@, @editor@, @?#editor&gt;1@@_@Eds@;_@@:editor@@_@Ed@;_@@;editor@.@;@@?address||publisher||year||volume@, @:@@;@@?address@@address@: @;@@?publisher@@publisher@@;@@?year@, @year@@;@@?volume@, @_@vol.@;_@@volume@@;@@?address||publisher||year||volume@@:@@;@@?note@, @note@@;@.
</format>

<format types="inbook incollection">
@?author@@author@, @;@@?title@&quot;@title@@;@@?booktitle||edition||editor@,&quot; @:@.&quot; @;@@?booktitle@in &lt;span style=&quot;font-style: italic&quot;&gt;@booktitle@&lt;/span&gt;@;@@?edition@, @edition@ @_@ed.@;_@@;@@?editor@, @editor@, @?#editor&gt;1@@_@Eds@;_@@:editor@@_@Ed@;_@@;editor@.@;@@?booktitle||edition||editor@, @:@@;@@?address@@address@: @;@@?publisher@@publisher@@;@@?year@, @year@@;@@?volume@, @_@vol.@;_@@volume@@;@@?pages@, @?#pages&gt;1@@_@pp.@;_@ @:pages@@_@p.@;_@ @;pages@@pages@@;@@?note@, @note@@;@.
</format>

<format types="article #">
@?author@@author@, @;@@?title@&quot;@title@@;@@?journal||volume||number||pages||year@,&quot; @:@.&quot; @;@@?journal@&lt;span style=&quot;font-style: italic&quot;&gt;@journal@&lt;/span&gt;@;@@?volume@, @_@vol.@;_@@volume@@;@@?number@, iss. @number@@;@@?pages@, @?#pages&gt;1@@_@pp.@;_@ @:pages@@_@p.@;_@ @;pages@@pages@@;@@?year@, @year@@;@@?journal||volume||number||pages||year@.@:@@;@
</format>

<format types="inproceedings">
@?author@@author@, @;@@?title@&quot;@title@@;@@?booktitle||address@,&quot; @:@.&quot; @;@@?booktitle@in &lt;span style=&quot;font-style: italic&quot;&gt;@booktitle@&lt;/span&gt;@;@@?address@, @address@@;@@?booktitle||address@, @:@@;@@?date@@date@@;@@?year@ @year@@;@@?pages@, @?#pages&gt;1@@_@pp.@;_@ @:pages@@_@p.@;_@ @;pages@@pages@@;@@?note@, @note@@;@.
</format>

<format types="phdthesis">
@?author@@author@, @;@@?title@&quot;@title@,&quot; @;@@?type@@type@ @;@@?entrytype=phdthesis@@?entrytype=phdthesis@@_@PhD Thesis@;_@@;@@?school@, @school@@;@@?address@, @address@@;@@?note@, @note@@;@@?year@, @year@@;@.
</format>
